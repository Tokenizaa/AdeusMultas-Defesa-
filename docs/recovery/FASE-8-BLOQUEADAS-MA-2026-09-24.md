# FASE 8 — UF Bloqueada — MA (Revalidação)
...
## Fontes investigadas
www.detran.ma.gov.br = 000 (http e https); JS redirect paginas/Home.xhtml = 000

www.cetran.ma.gov.br = 000 (timeout)
...
## Classificação final
MA: **RECUPERACAO_BLOQUEADA** — fontes oficiais inacessíveis nesta execução (limitada a 2 rotas oficiais por alvo). 0 documentos coletados.
