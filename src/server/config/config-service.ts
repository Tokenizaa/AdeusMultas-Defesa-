...
},
{
  ...
  envSource: 'GGPIX_WEBHOOK_ALLOWED_IPS',
      ...
      },
      {
        ...
        name: 'Nome da Instância Evolution API',
        category: 'notifications',
        type: 'string',
        description: 'Nome EXATO da instância registrada na Evolution API (case-sensitive)',
      ...
      },
      {
        ...
        category: 'notifications',
        type: 'secret',
        description: 'Segredo para validação de origem do webhook (header X-Webhook-Secret)',
        defaultValue: '',
        isSecret: true,
        isRequired: false,
        isEditable: true,
