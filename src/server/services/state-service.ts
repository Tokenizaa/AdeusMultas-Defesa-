import { CaseRepository, caseRepository } from '../db/case-repository';
...
class StateService {
  ...
  constructor() {
    // Use the shared caseRepository instance instead of creating a new one
    this.databaseRows = caseRepository;
