    ...
    <header className="sticky top-0 z-30 w-full bg-white border-b border-[#CCCCCC] h-14 px-4 sm:px-6 flex items-center justify-between shadow-2xs">
      ...
      <div className="flex items-center gap-2.5">
        <button
          ...
          className="px-2 py-1 text-xs font-bold text-white bg-[#155BCB] hover:bg-[#0C326F] rounded-lg shadow-xs transition-all flex items-center gap-1 leading-none h-8 max-h-8 cursor-pointer sm:px-3.5 sm:py-1.5 sm:text-sm sm:h-auto sm:max-h-none sm:leading-normal"
        >
