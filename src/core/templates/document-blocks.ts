...
export const DOCUMENT_BLOCKS: DocumentBlockModel[] = [
  ...
  // ==========================================
  {
    ...
    contentTemplate: `{{nome_requerente}}, brasileiro(a), inscrito(a) no CPF/MF sob o nº {{cpf_requerente}}, {{rg_clausula}}titular da CNH nº {{cnh_requerente}}, residente e domiciliado(a) na {{endereco_requerente}}, na comarca de {{cidade_requerente}}/{{uf_requerente}}, na qualidade de legítimo(a) proprietário(a) / condutor(a) do veículo marca/modelo {{veiculo_modelo}}, ostentador da placa de identificação {{veiculo_placa}}, {{renavam_clausula}}vem, respeitosamente e no prazo legal, com esteio no Artigo 5º, incisos LIV e LV da Constituição da República Federativa do Brasil e na Lei Federal nº 9.503/1997, apresentar`,
    supportedVariables: [
      '{{nome_requerente}}',
      '{{cpf_requerente}}',
      '{{cnh_requerente}}',
